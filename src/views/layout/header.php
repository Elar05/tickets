      ...
      <div id="scrollbar">
        <div class="container-fluid">
          ...
          <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link menu-link" href="#sidebarTickets" data-bs-toggle="collapse"
                role="button" aria-expanded="false" aria-controls="sidebarTickets">
                <i class="ri-dashboard-2-line"></i> <span data-key="t-tickets">Tickets</span>
              </a>
              <div class="collapse menu-dropdown" id="sidebarTickets">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="<?= URL ?>/tickets/nuevo-ticket" class="nav-link" data-key="t-nuevo-ticket">
                      Registrar Nuevo
                    </a>
                  </li>

                  <li class="nav-item">
                    <a href="<?= URL ?>/tickets/tickets-abiertos" class="nav-link" data-key="t-tickets-abiertos">
                      Tickets Abiertos
                    </a>
                  </li>

                  <li class="nav-item">
                    <a href="<?= URL ?>/tickets/tickets-cerrados" class="nav-link" data-key="t-tickets-cerrados">
                      Tickets Cerrados
                    </a>
                  </li>
                </ul>
            ...
            <li class="nav-item">
              <a class="nav-link menu-link" href="#sidebarInventario" data-bs-toggle="collapse"
                ...
                <i class="ri-dashboard-2-line"></i> <span data-key="t-inventario">Inventario</span>
              </a>
              <div class="collapse menu-dropdown" id="sidebarInventario">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="<?= URL ?>/inventario/productos" class="nav-link" data-key="t-inventario-productos">
                      Productos
                    </a>
                  </li>

                  <li class="nav-item">
                    <a href="<?= URL ?>/inventario/categorias" class="nav-link" data-key="t-inventario-categorias">
                      Categorias
                    </a>
                  </li>

                  <li class="nav-item">
                    <a href="<?= URL ?>/inventario/entradas" class="nav-link" data-key="t-inventario-entradas">
                      Entradas
                    </a>
                  </li>

                  <li class="nav-item">
                    <a href="<?= URL ?>/inventario/salidas" class="nav-link" data-key="t-inventario-salidas">
                      Salidas
                    </a>
                  </li>
                </ul>
            ...
            <li class="nav-item">
              <a class="nav-link menu-link" href="#sidebarSecurity" data-bs-toggle="collapse"
                role="button" aria-expanded="false" aria-controls="sidebarSecurity">
                <i class="ri-dashboard-2-line"></i> <span data-key="t-security">Seguridad</span>
              </a>
              <div class="collapse menu-dropdown" id="sidebarSecurity">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="<?= URL ?>/security/empresa" class="nav-link" data-key="t-security-empresa">
                      Empresas
                    </a>
                  </li>

                  <li class="nav-item">
                    <a href="<?= URL ?>/security/users" class="nav-link" data-key="t-security-users">
                      Usuarios
                    </a>
                  </li>

                  <li class="nav-item">
                    <a href="<?= URL ?>/security/user-types" class="nav-link" data-key="t-security-user-types">
                      Roles de Usuario
                    </a>
                  </li>

                  <li class="nav-item">
                    <a href="<?= URL ?>/security/user-actions" class="nav-link" data-key="t-security-user-actions">
                      Acciones
                    </a>
                  </li>
                </ul>
